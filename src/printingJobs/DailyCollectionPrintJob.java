...
public class DailyCollectionPrintJob implements Printable {
    String[] values = new String[10];
    String dairyName = "";
    String dairyAddress = "";

    public DailyCollectionPrintJob(String[] values, String dairyName, String dairyAddress) {
        this.values = values;
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        if (pageIndex == 0) {
            ...
            try {
                ...
                cH = y + 70;
                String[] strLabels = new String[]{"SHIFT: ", "PRD. NAME:", "ACC.No:", "MILK TYPE:", "LTR:", "FAT:", "SNF:", "LACTO:", "RATE:", "AMOUNT:"};
